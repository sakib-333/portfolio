...
export default function NavbarSimple({ open, handleToggle, handleScroll, activeSection}: Props) {
  ...
  return (
//     <header className="w-full bg-background border-b backdrop-blur sticky top-0 z-50 border-foreground/50">
      <div className="bg-primary/40 sticky top-0 z-50">
            <header className="container mx-auto w-full py-4 px-5">
