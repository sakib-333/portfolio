                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto">
                    ...
                    >
                        ...
                        <div className="p-6 space-y-4">
                            <div className="flex flex-wrap gap-2">
                                ...
                                <span className="px-2 py-1 bg-primary-container/20 text-primary text-[10px] font-bold uppercase tracking-wider rounded">TanStack Router</span>
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-white mb-2 font-space-grotesk">Digital Event Scheduler System</h3>
                                <p className="text-on-surface-variant text-sm">A modern solution for organizing and managing digital events with seamless integration and user-friendly interface.</p>
                            </div>
                            <div className="flex items-center gap-3 pt-2">
                                <a
                                    ...
                                    href="https://digital-event-scheduler-system.web.app"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                >
                                    Live Demo
                                ...
                                <a
                                    ...
                                    href="https://github.com/sakib-333/digital-event-scheduler-system"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                >
                                    Source Code
                    ...
                    >
                        ...
                        <div className="p-6 space-y-4">
                            <div className="flex flex-wrap gap-2">
                                <span className="px-2 py-1 bg-primary-container/20 text-primary text-[10px] font-bold uppercase tracking-wider rounded">React</span>
                                <span className="px-2 py-1 bg-primary-container/20 text-primary text-[10px] font-bold uppercase tracking-wider rounded">TypeScript</span>
                                <span className="px-2 py-1 bg-primary-container/20 text-primary text-[10px] font-bold uppercase tracking-wider rounded">TanStack Router</span>
                                <span className="px-2 py-1 bg-primary-container/20 text-primary text-[10px] font-bold uppercase tracking-wider rounded">Firebase</span>
                                <span className="px-2 py-1 bg-primary-container/20 text-primary text-[10px] font-bold uppercase tracking-wider rounded">Shadcn UI</span>
                            </div>
                            <div>
                    ...
                    >
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <div className="flex items-center gap-3 pt-2">
                                ...
                                <a
                                    className="flex-1 border border-zinc-700 text-white py-2 rounded-lg text-center text-sm font-bold hover:bg-zinc-800 transition-all"
                                    href="https://github.com/sakib-333/matrimony-platform-client"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                >
                                    Source Code
